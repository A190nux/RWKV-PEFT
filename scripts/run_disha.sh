load_model='/kaggle/working/rwkv-4-5.pth'
proj_dir='/kaggle/working/'
data_file='/kaggle/input/zh-en-post-dataset/split_part_5_text_document'
...
--lr_init 5e-6 --lr_final 5e-6 --warmup_steps 50 --beta1 0.9 --beta2 0.99 --adam_eps 1e-8 \
